...
#if defined TM4C123GH6PM_MPU6050_DMP_DRIVER
#define MPU6050
#define i2c_write   TM4_MPU6050_DMP_I2C_Write
#define i2c_read    TM4_MPU6050_DMP_I2C_Read
#define delay_ms    TM4_MPU6050_DMP_delayms
#define get_ms      TM4_MPU6050_DMP_getms
...
//得到 DMP 处理后的数据(注意,本函数需要比较多堆栈,局部变量有点多).返回值:0,正常.其他,失败
...
int mpu_init(void)                           //此处改掉了mpu_init()的参数**************************************************
{
